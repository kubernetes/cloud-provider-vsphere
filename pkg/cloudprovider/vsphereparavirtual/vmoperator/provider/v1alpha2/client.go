...
// Package v1alpha2 provides a dynamic client for the VM Operator v1alpha2 API.
package v1alpha2
...
// GVRs for the VM Operator v1alpha2 resources used by the CPI.
var (
...
// NewForConfig creates a new v1alpha2 Client from the given REST config.

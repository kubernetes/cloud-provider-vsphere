	...
	ipAddressAllocation := &vpcapisv1.IPAddressAllocation{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				...
				helper.LabelKeyClusterName: m.clusterName,
			},
...
func NewNSXVPCIPManager(client nsxclients.Interface, informerFactory nsxinformers.SharedInformerFactory, clusterName, svNamespace, podIPPoolType string, ownerRef *metav1.OwnerReference, ipv4Enabled, ipv6Enabled bool) NSXIPManager {

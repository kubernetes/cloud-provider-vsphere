	...
	testcases := []testCase{
		{
			...
			actions: []core.Action{
				core.NewCreateAction(
					schema.GroupVersionResource{Resource: "ipaddressallocations", Group: nsxapisv1alpha1.GroupVersion.Group, Version: nsxapisv1alpha1.GroupVersion.Version},
					ns,
					&nsxapisv1alpha1.IPAddressAllocation{
						ObjectMeta: metav1.ObjectMeta{
							Name:      nodeName,
							Namespace: ns,
						...
						Spec: nsxapisv1alpha1.IPAddressAllocationSpec{
							IPAddressBlockVisibility: nsxapisv1alpha1.IPAddressVisibilityExternal,
			...
			actions: []core.Action{
				core.NewCreateAction(
					...
					&nsxapisv1alpha1.IPAddressAllocation{
						...
						Spec: nsxapisv1alpha1.IPAddressAllocationSpec{
							IPAddressBlockVisibility: nsxapisv1alpha1.IPAddressVisibilityPrivate,
							AllocationSize:           allocationSize,
						},
					},
				),
...
func TestNSXVPCIPManager_ReleasePodCIDR(t *testing.T) {
	...
	ipa := &nsxapisv1alpha1.IPAddressAllocation{
		ObjectMeta: metav1.ObjectMeta{
			Name:      nodeName,
			Namespace: ns,
		},

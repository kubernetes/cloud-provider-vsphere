	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VmoperatorV1alpha1().VirtualMachineClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VmoperatorV1alpha1().VirtualMachineClasses().Watch(context.TODO(), options)
			},
		},
		&vmopv1alpha1.VirtualMachineClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMachineClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vmopv1alpha1.VirtualMachineClass{}, f.defaultInformer)
}

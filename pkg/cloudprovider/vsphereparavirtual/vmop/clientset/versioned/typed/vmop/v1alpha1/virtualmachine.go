...
type VirtualMachineInterface interface {
	...
	Apply(ctx context.Context, virtualMachine *vmopv1alpha1.VirtualMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualMachine, err error)
	ApplyStatus(ctx context.Context, virtualMachine *vmopv1alpha1.VirtualMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualMachine, err error)
...
func (c *virtualMachines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualMachineList, err error) {
...
func (c *virtualMachines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualMachines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualMachines) Apply(ctx context.Context, virtualMachine *vmopv1alpha1.VirtualMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualMachine, err error) {
...
func (c *virtualMachines) ApplyStatus(ctx context.Context, virtualMachine *vmopv1alpha1.VirtualMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.VirtualMachine, err error) {
	if virtualMachine == nil {
		return nil, fmt.Errorf("virtualMachine provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()

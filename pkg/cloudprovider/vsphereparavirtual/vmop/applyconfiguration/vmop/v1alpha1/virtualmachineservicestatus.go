...
// VirtualMachineServiceStatusApplyConfiguration represents an declarative configuration of the VirtualMachineServiceStatus type for use
// with apply.
...
// VirtualMachineServiceStatusApplyConfiguration constructs an declarative configuration of the VirtualMachineServiceStatus type for use with
// apply.

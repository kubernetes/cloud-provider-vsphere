...
// VirtualMachineServicePortApplyConfiguration represents an declarative configuration of the VirtualMachineServicePort type for use
// with apply.
...
// VirtualMachineServicePortApplyConfiguration constructs an declarative configuration of the VirtualMachineServicePort type for use with
// apply.

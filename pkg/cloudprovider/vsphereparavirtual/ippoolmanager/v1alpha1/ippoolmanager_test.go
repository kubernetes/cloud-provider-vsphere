...
func initIPPoolTest() (*IPPoolManager, *faket1networkingclients.Clientset) {
...
func TestAddDeleteSubnetToIPPool(t *testing.T) {
	...
	for _, testCase := range testcases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			assert.Equal(t, nil, err)
			ippools, err := ippcs.NsxV1alpha1().IPPools(testClusterNameSpace).List(context.Background(), metav1.ListOptions{})

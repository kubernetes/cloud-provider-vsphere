...
type NodesYAML struct {
	...
	InternalNetworkSubnetCIDR string `yaml:"internal-network-subnet-cidr"`
	ExternalNetworkSubnetCIDR string `yaml:"external-network-subnet-cidr"`
	...
	InternalVMNetworkName string `yaml:"internal-vm-network-name"`
	ExternalVMNetworkName string `yaml:"external-vm-network-name"`
}

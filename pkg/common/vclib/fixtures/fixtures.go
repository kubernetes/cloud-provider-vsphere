...
func init() {
	...
	fmt.Println("fixturesDir:", fixturesDir)
	...
	// DYV: Need to remove? Are we using bazel?
	...
	// 	fmt.Println("fixturesDir OLD:", fixturesDir)
	// 	fixturesDir = filepath.Join(cwd, fixturesDir)
	// 	fmt.Println("fixturesDir NEW:", fixturesDir)
	// }

...
type GlobalYAML struct {
	...
	SecretNamespace string `yaml:"secret-namespace"`
...
// ConfigYAML is used to read and store information from the cloud configuration file
type ConfigYAML struct {
	// Global values...
	Global GlobalYAML

	// Virtual Center configurations
	VirtualCenter map[string]*VirtualCenterConfigYAML

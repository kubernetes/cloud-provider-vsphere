...
require (
	...
	k8s.io/cloud-provider v0.30.0-beta.0
...
require (
	...
	k8s.io/apiserver v0.30.0-beta.0 // indirect
	k8s.io/component-helpers v0.30.0-beta.0 // indirect
	k8s.io/controller-manager v0.30.0-beta.0 // indirect

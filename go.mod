...
require (
	...
	k8s.io/cloud-provider v0.32.0-rc.1
...
require (
	...
	k8s.io/apiserver v0.32.0-rc.1 // indirect
	k8s.io/component-helpers v0.32.0-rc.1 // indirect
	k8s.io/controller-manager v0.32.0-rc.1 // indirect
